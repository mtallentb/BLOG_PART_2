...
let postData = require('./xhr.js');
let blogTemplate = require('../templates/post-grid.hbs');
...
function deleteButtons() {
	...
	for (let i = 0; i < $('.deleteBtn').length; i++) {
		...
		$('#deleteBtn-${i}').click(console.log("Click delete button #", i));
	}
}
...
postData.loadPosts()
.then(
	(postsFromLoadPostsResolve) => {
		console.log("Posts Promise: ", postsFromLoadPostsResolve);
		populatePage(postsFromLoadPostsResolve);
	},
	(reject) => {
...
},{"../lib/node_modules/hbsfy/runtime":23,"../templates/post-grid.hbs":24,"./xhr.js":3}],2:[function(require,module,exports){
"use strict";

console.log("Main JS");

let Handlebars = require('../lib/node_modules/hbsfy/runtime');
let getPosts = require ('./getPosts.js');
let addBlogLink = document.getElementById("addBlogLink");
let blogListLink = document.getElementById("blogListLink");
let addBlogEntryView = document.getElementById("addBlogEntryView");
let blogListView = document.getElementById("blogListView");

addBlogLink.addEventListener('click', function() {
	addBlogEntryView.classList.remove('hide');
	blogListView.classList = 'hide';
});

blogListLink.addEventListener('click', function() {
	blogListView.classList.remove('hide');
	addBlogEntryView.classList = 'hide';
});

let blogTitle = document.getElementById("blog-title");
let blogDate = document.getElementById("blog-date");
let blogAuthor = document.getElementById("blog-author");
let blogEntry = document.getElementById("blog-entry");
let blogKeywords = document.getElementById("blog-keywords");
	...
	newArticles.innerHTML += `
			<article>
				...
				<section class="article-footer">
					<p>Author: <a href="#">${blogAuthor.value}</a></p>
					<p>Date: ${blogDate.value}</p>
				</section>
				<section>
					<p>${blogKeywords.value}</p>
				</section>
...
},{"../lib/node_modules/hbsfy/runtime":23,"./getPosts.js":1}],3:[function(require,module,exports){
"use strict";
...
xhr.loadPosts = () => {
	return new Promise (function(resolve, reject){
		let postLoader = new XMLHttpRequest();
		postLoader.open('GET', '../posts.json');
		postLoader.send();

		postLoader.addEventListener('load', function() {
...
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "	<article id=\"post-"
    + alias3((helpers.incrementer || (depth0 && depth0.incrementer) || alias2).call(alias1,(data && data.index),{"name":"incrementer","hash":{},"data":data}))
    + "\">\n		<section class=\"article-header\">\n			<h1>"
    ...
    + "</h1>\n		</section>\n		<section class=\"article-content\">\n			<p>"
    + alias3(((helper = (helper = helpers.entry || (depth0 != null ? depth0.entry : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"entry","hash":{},"data":data}) : helper)))
    + "</p>\n		</section>\n		<section class=\"article-footer\">\n			<p>Author: <a href=\"#\">"
    + alias3(((helper = (helper = helpers.author || (depth0 != null ? depth0.author : depth0)) != null ? helper : alias2),(typeof helper === alias4 ? helper.call(alias1,{"name":"author","hash":{},"data":data}) : helper)))
    + "</a></p>\n			<p>Date: "
    ...
    + "</p>\n		</section>\n		<button type=\"button\" class=\"btn-danger btn deleteBtn\" id=\"deleteBtn-"
    + alias3((helpers.incrementer || (depth0 && depth0.incrementer) || alias2).call(alias1,(data && data.index),{"name":"incrementer","hash":{},"data":data}))
    + "\">Delete</button>\n	</article>\n\n";
